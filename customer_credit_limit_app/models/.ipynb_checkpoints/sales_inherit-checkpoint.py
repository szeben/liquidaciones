...
class sale_order(models.Model):
    ...
    def action_confirm(self):
        ...
        flag = False
        res = True
        approval = self.env['ir.config_parameter'].get_param('customer_credit_limit_app.sale_approve','before')
        due_date = self.env['ir.config_parameter'].get_param('customer_credit_limit_app.due_date_check',False)
