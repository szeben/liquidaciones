...
export class QtyAtDateWidgetExtension extends Component {
    setup() {
    ...
    initCalcData() {
        ...
        }else if (data.free_qty_today == data.qty_to_deliver){
...
QtyAtDateWidgetExtension.components = { Popover: QtyAtDatePopover };
QtyAtDateWidgetExtension.template = "new_expected_inventory_status.qtyAtDateExtension";

registry.category("view_widgets").add("qty_at_date_widget_extended", QtyAtDateWidgetExtension);
