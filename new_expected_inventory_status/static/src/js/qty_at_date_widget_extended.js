odoo.define('new_expected_inventory_status.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidgetExtension = Widget.extend({
    template: 'new_expected_inventory_status.qtyAtDate',
...
widget_registry.add('qty_at_date_widget_extended', QtyAtDateWidgetExtension);

return QtyAtDateWidgetExtension;
});
